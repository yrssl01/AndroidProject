...
import com.example.newapp.databinding.FragmentOnlineBinding
...
import com.example.newapp.viewModel.OnlineViewModel
    ...
    private fun init() {
        newsAdapter.onArticleClicked {
            ...
            findNavController().navigate(
                R.id.action_onlineFragment_to_DetailsFragment,
                bundle
            )
        }
